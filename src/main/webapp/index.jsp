...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Nitin Mudgal</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Nitin's Website</h1>
			<!-- Icon Divider-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">Management Consulting - Software Engineering - Business & Data Analytics</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">This is Nitin Mudgal's Personal website</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">With close to a decade of experience at the intersection of finance and technology, Nitin strives to learn more 
					to keep up with the fast paced technical landscape. </p>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						Tower 5, 1802 BPTP Park <br /> Gurgaon, HR 122001
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About Nitin</h4>
					<p class="lead mb-0">
						Nitin aims to help build sustainable businesses utilizing the talent pool available in non-metro indian cities.
					</p>
				</div>
			</div>
		</div>
